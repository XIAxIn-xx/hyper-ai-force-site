          ...
          {content.strengths.items.map((item, index) => {
            ...
            return (
              <Reveal key={item.title} delay={index * 0.05}>
                <div className="h-full rounded-lg border border-[#E6EAF0] bg-white p-6 shadow-[0_12px_34px_rgba(15,23,42,0.05)] transition hover:-translate-y-1 hover:border-cyan-300 hover:shadow-glow">
