...
const content = {
  ...
  "zh-hk": {
    ...
    hero: {
      ...
      title: "面向真實產業場景的\nAI 機器人智能系統",
      subtitle:
        "我們將 AI 感知、自主巡航、遠程遙操、運動控制與場景交付能力結合，為物理安全、巡邏巡檢與設施運維等場景提供可部署的機器人方案",
      primaryCta: "預約演示",
      secondaryCta: "了解技術",
      stats: [
    ...
    strengths: {
      ...
      items: [
        ...
        },
        {
          ...
          title: "遠程遙操能力",
          text:
            "低延遲遠程遙操作確保操作人員始終可參與控制流程，實現即時監督、緊急接管與精準的現場干預。"
        }
      ]
    },
    technology: {
  ...
  "zh-cn": {
    ...
    hero: {
      ...
      title: "面向真实产业场景的\nAI 机器人智能系统",
      subtitle:
        "我们将 AI 感知、自主巡航、远程遥操、运动控制与场景交付能力结合，为物理安全、巡逻巡检与设施运维等场景提供可部署的机器人方案",
      primaryCta: "预约演示",
      secondaryCta: "了解技术",
      stats: [
    ...
    strengths: {
      ...
      items: [
        ...
        },
        {
          ...
          title: "远程遥操能力",
          text:
            "低延迟远程遥操作确保操作人员始终可参与控制流程，实现实时监督、紧急接管与精准现场干预。"
        }
      ]
    },
    technology: {
