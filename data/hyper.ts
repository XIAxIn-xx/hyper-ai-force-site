...
const content = {
  ...
  "zh-cn": {
    ...
    about: {
      ...
      copy: [
        "超流智能专注于机器人在安防巡逻、物流仓储和社区安防等物理安全场景中的应用，围绕自主巡航、远程遥操与多机调度，提供从方案配置、部署调试到持续运营的一站式服务。",
        "超流智能赋能客户构建自主巡检与远程遥操相结合的机器人巡检方案，让机器人承担夜间、重复性及高风险任务，并在复杂情况或异常事件发生时由人工及时远程介入，帮助客户扩大巡检覆盖范围、降低人员暴露风险，提升长期运营效率与稳定性。"
      ],
      bullets: [
        "面向物理世界产业的具身智能",
        "基于AI能力的软硬件一体化交付",
